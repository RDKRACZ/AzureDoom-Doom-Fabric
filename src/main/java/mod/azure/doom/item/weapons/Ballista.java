...
public class Ballista extends CrossbowItem {
	...
	private static boolean loadProjectile(LivingEntity shooter, ItemStack crossbow, ItemStack projectile,
		...
		if (projectile.isEmpty()) {
			...
			boolean bl = creative && projectile.getItem() instanceof ArgentBolt;
	...
	private static ArgentBoltEntity createArrow(World world, LivingEntity entity, ItemStack crossbow, ItemStack arrow) {
		ArgentBolt ArgentBolt = (ArgentBolt) ((ArgentBolt) (arrow.getItem() instanceof ArgentBolt ? arrow.getItem()
				: DoomItems.ARGENT_BOLT));
		ArgentBoltEntity persistentProjectileEntity = ArgentBolt.createArrow(world, arrow, entity);
