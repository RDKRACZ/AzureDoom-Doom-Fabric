...
public class SuperShotgun extends DoomBaseItem implements IAnimatable {
	...
	public SuperShotgun() {
		super(new Item.Settings().group(DoomMod.DoomWeaponItemGroup).maxCount(1).maxDamage(52));
	}
