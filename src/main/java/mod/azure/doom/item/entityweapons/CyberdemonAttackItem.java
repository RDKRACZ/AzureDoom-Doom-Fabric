...
public class CyberdemonAttackItem extends RangedWeaponItem {

	public CyberdemonAttackItem() {
	...
	public void usageTick(World worldIn, LivingEntity livingEntityIn, ItemStack stack, int count) {
		if (livingEntityIn instanceof PlayerEntity) {
			...
			if (!itemStack.isEmpty() || bl) {
				...
				boolean bl2 = bl && itemStack.getItem() == DoomItems.ROCKET;
				if (!worldIn.isClient) {
					Rocket arrowItem = (Rocket) ((Rocket) (itemStack.getItem() instanceof Rocket ? itemStack.getItem()
							: DoomItems.ROCKET));
					RocketEntity persistentProjectileEntity = arrowItem.createArrow(worldIn, itemStack, playerEntity);
	...
	public Rocket customeArrow(Rocket abstractarrowentity) {
