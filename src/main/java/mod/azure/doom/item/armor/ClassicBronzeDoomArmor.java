...
public class ClassicBronzeDoomArmor extends GeoArmorItem implements IAnimatable {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(
				new AnimationController<ClassicBronzeDoomArmor>(this, "controller", 20, this::predicate));
	}
