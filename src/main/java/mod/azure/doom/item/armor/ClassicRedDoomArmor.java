...
public class ClassicRedDoomArmor extends GeoArmorItem implements IAnimatable {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(
				new AnimationController<ClassicRedDoomArmor>(this, "controller", 20, this::predicate));
	}
