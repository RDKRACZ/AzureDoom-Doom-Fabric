...
public class Mullet2DoomArmor extends GeoArmorItem implements IAnimatable {

	private AnimationFactory factory = new AnimationFactory(this);

	@Override
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<Mullet2DoomArmor>(this, "controller", 20, this::predicate));
	}
	...
	public Mullet2DoomArmor(ArmorMaterial materialIn, EquipmentSlot slot) {
