...
public class HotrodDoomArmor extends GeoArmorItem implements IAnimatable {

	private AnimationFactory factory = new AnimationFactory(this);

	@Override
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<HotrodDoomArmor>(this, "controller", 20, this::predicate));
	}
	...
	public HotrodDoomArmor(ArmorMaterial  materialIn, EquipmentSlot  slot) {
