...
public class ClassicIndigoDoomArmor extends GeoArmorItem implements IAnimatable {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(
				new AnimationController<ClassicIndigoDoomArmor>(this, "controller", 20, this::predicate));
	}
