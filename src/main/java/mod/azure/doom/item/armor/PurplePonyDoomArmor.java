...
public class PurplePonyDoomArmor extends GeoArmorItem implements IAnimatable {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(
				new AnimationController<PurplePonyDoomArmor>(this, "controller", 20, this::predicate));
	}
	...
	public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
		tooltip.add(new TranslatableText("doom.purplearmor.text").formatted(Formatting.YELLOW)
