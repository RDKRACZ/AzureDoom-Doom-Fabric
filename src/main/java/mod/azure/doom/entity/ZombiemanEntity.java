...
public class ZombiemanEntity extends DemonEntity {
	...
	protected void initGoals() {
		...
		this.goalSelector.add(7, new ZombiemanEntity.ShootFireballGoal(this));
	...
	static class ShootFireballGoal extends Goal {
		private final ZombiemanEntity ghast;
		public int cooldown;

		public ShootFireballGoal(ZombiemanEntity ghast) {
			this.ghast = ghast;
		}
