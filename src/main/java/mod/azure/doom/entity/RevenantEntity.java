...
public class RevenantEntity extends DemonEntity implements RangedAttackMob {

	private final RangedBarenBlastAttackGoal<RevenantEntity> aiArrowAttack = new RangedBarenBlastAttackGoal<>(this,
			1.0D, 20, 15.0F);
	private final MeleeAttackGoal meleeAttackGoal = new MeleeAttackGoal(this, 1.2D, false) {
		public void stop() {
			super.stop();
			RevenantEntity.this.setAttacking(false);
		}

		public void start() {
			super.start();
			RevenantEntity.this.setAttacking(true);
		}
	};
