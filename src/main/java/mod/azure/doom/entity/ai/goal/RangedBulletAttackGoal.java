...
public class RangedBulletAttackGoal<T extends HostileEntity & RangedAttackMob> extends Goal {
	...
	public RangedBulletAttackGoal(T actor, double speed, int attackInterval, float range) {
		this.actor = actor;
		this.speed = speed;
