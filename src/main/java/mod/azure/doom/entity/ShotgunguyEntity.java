...
public class ShotgunguyEntity extends DemonEntity {
	...
	protected void initGoals() {
		...
		this.goalSelector.add(7, new ShotgunguyEntity.ShootFireballGoal(this));
	...
	static class ShootFireballGoal extends Goal {
		private final ShotgunguyEntity ghast;
		public int cooldown;

		public ShootFireballGoal(ShotgunguyEntity ghast) {
			this.ghast = ghast;
		}
		...
		public void tick() {
			...
			if (livingEntity.squaredDistanceTo(this.ghast) < 4096.0D && this.ghast.canSee(livingEntity)) {
				...
				if (this.cooldown == 20) {
					...
					ShotgunMobEntity fireballEntity = new ShotgunMobEntity(world, this.ghast, f, g, h);
