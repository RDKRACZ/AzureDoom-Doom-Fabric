...
public class NightmareImpEntity extends DemonEntity implements IAnimatable {
	private static final TrackedData<Boolean> SHOOTING = DataTracker.registerData(NightmareImpEntity.class,
	...
	protected void initCustomGoals() {
		this.goalSelector.add(7, new NightmareImpEntity.ShootFireballGoal(this));
	...
	static class ShootFireballGoal extends Goal {
		private final NightmareImpEntity ghast;
		public int cooldown;

		public ShootFireballGoal(NightmareImpEntity ghast) {
			this.ghast = ghast;
		}
