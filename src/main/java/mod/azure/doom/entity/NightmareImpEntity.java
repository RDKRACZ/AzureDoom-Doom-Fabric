...
public class NightmareImpEntity extends DemonEntity implements IAnimatedEntity {
	...
	EntityAnimationController<NightmareImpEntity> controller = new EntityAnimationController<NightmareImpEntity>(this, "walkController",
	...
	private <E extends Entity> boolean animationPredicate(AnimationTestEvent<E> event) {
		...
		if (this.isAttacking()) {
            controller.setAnimation(new AnimationBuilder().addAnimation("attacking"));
            return true;
		}
		if (this.isDead()) {
			if (world.isClient) {
