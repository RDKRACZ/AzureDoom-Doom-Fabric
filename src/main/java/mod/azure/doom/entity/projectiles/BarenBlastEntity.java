...
public class BarenBlastEntity extends PersistentProjectileEntity {
	...
	public BarenBlastEntity(EntityType<? extends BarenBlastEntity> entityType, World world) {
		super(entityType, world);
		this.pickupType = PersistentProjectileEntity.PickupPermission.DISALLOWED;
	}

	public BarenBlastEntity(World world, LivingEntity owner) {
		super(ProjectilesEntityRegister.ARGENT_BOLT, owner, world);
	}

	protected BarenBlastEntity(EntityType<? extends BarenBlastEntity> type, double x, double y, double z, World world) {
		this(type, world);
	}

	protected BarenBlastEntity(EntityType<? extends BarenBlastEntity> type, LivingEntity owner, World world) {
