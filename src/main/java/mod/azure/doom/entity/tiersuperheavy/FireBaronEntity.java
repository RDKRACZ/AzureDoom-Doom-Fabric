...
public class FireBaronEntity extends DemonEntity implements IAnimatable {
	private static final TrackedData<Boolean> SHOOTING = DataTracker.registerData(FireBaronEntity.class,
	...
	protected void initGoals() {
		...
		this.goalSelector.add(4, new RangedStaticAttackGoal(this, new FireBaronEntity.FireballAttack(this)
