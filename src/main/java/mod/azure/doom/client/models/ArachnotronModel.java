...
public class ArachnotronModel extends AnimatedEntityModel<ArachnotronEntity> {
	...
	public ArachnotronModel() {
		...
		rLeg2_1_flat.setRotationPoint(7.0F, 10.0F, 9.0F);
		rLeg2_1_flat.setTextureOffset(0, 33).addBox(1.0F, 0.0F, -2.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		rLeg1_1_flat.setRotationPoint(7.0F, 10.5F, -9.0F);
		rLeg1_1_flat.setTextureOffset(0, 33).addBox(1.0F, 0.0F, -2.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		lLeg2_1_flat.setRotationPoint(-8.0F, 10.0F, 9.0F);
		lLeg2_1_flat.setTextureOffset(0, 33).addBox(1.0F, 0.0F, -2.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		lLeg1_1_flat.setRotationPoint(-8.0F, 10.5F, -9.0F);
		lLeg1_1_flat.setTextureOffset(0, 33).addBox(1.0F, 0.0F, -2.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		topL.setTextureOffset(0, 55).addBox(-1.0F, -5.0F, -9.5F, 10.0F, 5.0F, 19.0F, 0.0F, false);
		...
		lowTeeth.setTextureOffset(0, 64).addBox(-3.0F, 0.0F, 0.0F, 3.0F, 1.0F, 2.0F, 0.0F, false);
		...
		lEye.setTextureOffset(0, 0).addBox(-7.0F, -5.0F, 0.0F, 7.0F, 5.0F, 1.0F, 0.0F, false);
		...
		topTeeth.setTextureOffset(0, 15).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 1.0F, 2.0F, 0.0F, false);
		...
		rEye.setTextureOffset(0, 0).addBox(0.0F, -5.0F, 0.0F, 7.0F, 5.0F, 1.0F, 0.0F, false);
		...
		topR.setTextureOffset(0, 55).addBox(-9.0F, -5.0F, -9.5F, 10.0F, 5.0F, 19.0F, 0.0F, false);
		...
		gunBarrel.setTextureOffset(54, 43).addBox(-2.0F, 0.0F, -4.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);
		gunBarrel.setModelRendererName("gunBarrel");
		this.registerModelRenderer(gunBarrel);

		this.rootBones.add(rLeg2_1_flat);
		this.rootBones.add(rLeg1_1_flat);
		this.rootBones.add(lLeg2_1_flat);
		this.rootBones.add(lLeg1_1_flat);
