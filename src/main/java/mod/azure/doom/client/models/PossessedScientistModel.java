...
public class PossessedScientistModel<T extends DemonEntity> extends BipedEntityModel<T> {
	...
	public PossessedScientistModel(float modelSize, boolean smallArmsIn) {
		...
		this.leftArmwear.addCuboid(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, modelSize + 0.25F);
		this.leftArmwear.setPivot(5.0F, 2.0F, 0.0F);
		this.bipedRightArmwear = new ModelPart(this, 40, 32);
		this.bipedRightArmwear.addCuboid(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, modelSize + 0.25F);
		this.bipedRightArmwear.setPivot(-5.0F, 2.0F, 10.0F);
		...
		this.leftLegwear.addCuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, modelSize + 0.25F);
		this.leftLegwear.setPivot(1.9F, 12.0F, 0.0F);
		this.bipedRightLegwear = new ModelPart(this, 0, 32);
		this.bipedRightLegwear.addCuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, modelSize + 0.25F);
		this.bipedRightLegwear.setPivot(-1.9F, 12.0F, 0.0F);
		this.bipedBodyWear = new ModelPart(this, 16, 32);
		this.bipedBodyWear.addCuboid(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, modelSize + 0.25F);
		this.bipedBodyWear.setPivot(0.0F, 0.0F, 0.0F);
	}

	protected Iterable<ModelPart> getBodyParts() {
		return Iterables.concat(super.getBodyParts(), ImmutableList.of(this.leftLegwear, this.bipedRightLegwear,
				this.leftArmwear, this.bipedRightArmwear, this.bipedBodyWear));
	}
