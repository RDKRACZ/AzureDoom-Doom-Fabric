...
public class HellknightModel<T extends Entity> extends EntityModel<T> {
	...
	public HellknightModel() {
		...
		this.lowJaw_flat = new ModelPart(this, 0, 123);
		this.lowJaw_flat.setPivot(0.0F, -1.0F, -6.5F);
		this.lowJaw_flat.addCuboid(-3.0F, -1.0F, -5.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F);
	...
	public void setAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		this.lowJaw_flat.pitch = MathHelper.cos(limbSwing * 0.6662F) * 1.0F * limbSwingAmount / 1.3F;
	}
