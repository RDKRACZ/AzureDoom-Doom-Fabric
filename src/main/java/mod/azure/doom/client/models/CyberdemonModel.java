...
public class CyberdemonModel<T extends Entity> extends EntityModel<T> {
	...
	public CyberdemonModel(float modelSize, boolean smallArmsIn) {
		...
		this.rLeg3_2.addCuboid(-2.5F, 0.0F, -1.5F, 5.0F, 3.0F, 3.0F, 0.0F, 0.0F, 0.0F);
		...
		this.lLeg3.addCuboid(-2.5F, 0.0F, -4.0F, 5.0F, 11.0F, 4.0F, 0.0F, 0.0F, 0.0F);
		...
		this.rLeg1.addCuboid(-3.5F, 0.0F, -3.5F, 7.0F, 14.0F, 7.0F, 0.0F, 0.0F, 0.0F);
		this.setRotateAngle(rLeg1, -0.43022365395869955F, 0.0F, 0.0F);
		this.rLeg1_flat = new ModelPart(this, 0, 67);
		this.rLeg1_flat.setPivot(-4.0F, -5.1F, 0.0F);
		...
		this.armWires.addCuboid(-5.0F, 0.0F, -4.0F, 5.0F, 14.0F, 4.0F, 0.0F, 0.0F, 0.0F);
		...
		this.gunBase.addCuboid(-3.5F, 0.0F, -4.0F, 7.0F, 9.0F, 8.0F, 0.0F, 0.0F, 0.0F);
		...
		this.rArm1.addCuboid(-3.0F, 0.0F, -3.0F, 6.0F, 10.0F, 6.0F, 0.0F, 0.0F, 0.0F);
		this.rLegP1 = new ModelPart(this, 28, 64);
		this.rLegP1.setPivot(-4.0F, 0.5F, 0.0F);
		this.rLegP1.addCuboid(0.0F, 0.0F, -3.0F, 1.0F, 14.0F, 6.0F, 0.0F, 0.0F, 0.0F);
		...
		this.lArm.addCuboid(-3.0F, 0.0F, -3.0F, 6.0F, 10.0F, 6.0F, 0.0F, 0.0F, 0.0F);
		this.gunBarrel = new ModelPart(this, 54, 106);
		this.gunBarrel.setPivot(0.0F, 9.0F, 0.0F);
		this.gunBarrel.addCuboid(-2.0F, 0.0F, -2.5F, 5.0F, 12.0F, 5.0F, 0.0F, 0.0F, 0.0F);
		this.lLeg1 = new ModelPart(this, 0, 46);
		this.lLeg1.setPivot(0.0F, 0.0F, 0.0F);
		this.lLeg1.addCuboid(-3.5F, 0.0F, -3.5F, 7.0F, 14.0F, 7.0F, 0.0F, 0.0F, 0.0F);
		...
		this.lArm2.addCuboid(-3.0F, 0.0F, -6.0F, 6.0F, 6.0F, 6.0F, 0.0F, 0.0F, 0.0F);
		...
		this.lLeg2.addCuboid(-3.0F, 0.0F, -0.5F, 6.0F, 13.0F, 5.0F, 0.0F, 0.0F, 0.0F);
		...
		this.rLegP2.addCuboid(0.0F, 0.0F, -3.0F, 1.0F, 14.0F, 6.0F, 0.0F, 0.0F, 0.0F);
		...
		this.lShoulder.setPivot(7.5F, -12.0F, -6.0F);
		this.lShoulder.addCuboid(-1.0F, -2.0F, -4.0F, 7.0F, 8.0F, 7.0F, 0.0F, 0.0F, 0.0F);
		...
		this.rShoulder.setPivot(-7.5F, -12.0F, -6.0F);
		this.rShoulder.addCuboid(-6.0F, -2.0F, -4.0F, 7.0F, 8.0F, 7.0F, 0.0F, 0.0F, 0.0F);
		...
		this.rLeg2.addCuboid(-2.5F, 0.0F, -0.5F, 5.0F, 11.0F, 5.0F, 0.0F, 0.0F, 0.0F);
		...
		this.rLeg3.addCuboid(-3.0F, 0.0F, -4.0F, 6.0F, 7.0F, 4.0F, 0.0F, 0.0F, 0.0F);
		...
		this.gunrim.setPivot(1.0F, 11.5F, 0.0F);
		this.gunrim.addCuboid(-1.5F, 0.0F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, 0.0F, 0.0F);
		...
		this.rArm2.addCuboid(-3.0F, 0.0F, -6.0F, 6.0F, 15.0F, 6.0F, 0.0F, 0.0F, 0.0F);
