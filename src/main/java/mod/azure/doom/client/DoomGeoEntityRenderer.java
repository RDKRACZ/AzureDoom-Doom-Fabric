...
public class DoomGeoEntityRenderer<T extends LivingEntity & IAnimatable> extends EntityRenderer<T>
	...
	protected DoomGeoEntityRenderer(EntityRenderDispatcher renderManager, AnimatedGeoModel<T> modelProvider) {
		super(renderManager);
