...
public class LayerFlames extends FeatureRenderer<LostSoulEntity, LostSoulModel> {
	...
	public LayerFlames(FeatureRendererContext<LostSoulEntity, LostSoulModel> featureRendererContext) {
