...
public class ShotgunShellMobRender<T extends ShotgunMobEntity> extends EntityRenderer<T> {
	...
	public ShotgunShellMobRender(EntityRenderDispatcher renderManagerIn) {
		super(renderManagerIn);
	}

	@Override
	public Identifier getTexture(ShotgunMobEntity entity) {
