...
public class PossessedScientistRender
		extends MobEntityRenderer<PossessedScientistEntity, UnarmedModel<PossessedScientistEntity>> {
	...
	public PossessedScientistRender(EntityRenderDispatcher renderManagerIn) {
		super(renderManagerIn, new UnarmedModel<PossessedScientistEntity>(0.5f, false), 0.5f);
