...
public class ChaingunBulletMobRender<T extends ChaingunMobEntity> extends EntityRenderer<T> {
	...
	public ChaingunBulletMobRender(EntityRenderDispatcher renderManagerIn) {
