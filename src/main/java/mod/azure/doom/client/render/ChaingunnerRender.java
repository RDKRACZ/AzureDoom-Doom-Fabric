...
public class ChaingunnerRender extends MobEntityRenderer<ChaingunnerEntity, DemonModel<ChaingunnerEntity>> {
	...
	public ChaingunnerRender(EntityRenderDispatcher renderManagerIn) {
		super(renderManagerIn, new DemonModel<ChaingunnerEntity>(0.5f, false), 0.5f);
