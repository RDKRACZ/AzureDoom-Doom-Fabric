...
public class UnwillingRender extends MobEntityRenderer<UnwillingEntity, HumanModel<UnwillingEntity>> {
	...
	public UnwillingRender(EntityRenderDispatcher renderManagerIn) {
		super(renderManagerIn, new HumanModel<UnwillingEntity>(0.5f, false), 0.5f);
	}
