...
public class ClassicRedRender extends GeoArmorRenderer<ClassicRedDoomArmor> {
	...
	@Override
	public void render(GeoModel model, ClassicRedDoomArmor animatable, float partialTicks, RenderLayer type,
			MatrixStack matrixStackIn, VertexConsumerProvider RenderLayerBuffer, VertexConsumer vertexBuilder,
			int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		super.render(model, animatable, partialTicks, type, matrixStackIn, RenderLayerBuffer, vertexBuilder, packedLightIn,
