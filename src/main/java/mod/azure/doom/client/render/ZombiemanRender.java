...
public class ZombiemanRender extends MobEntityRenderer<ZombiemanEntity, DemonModel<ZombiemanEntity>> {
	...
	public ZombiemanRender(EntityRenderDispatcher renderManagerIn) {
		super(renderManagerIn, new DemonModel<ZombiemanEntity>(0.5f, false), 0.5f);
