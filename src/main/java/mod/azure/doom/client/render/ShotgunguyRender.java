...
public class ShotgunguyRender extends MobEntityRenderer<ShotgunguyEntity, HumanModel<ShotgunguyEntity>> {
	...
	public ShotgunguyRender(EntityRenderDispatcher renderManagerIn) {
		super(renderManagerIn, new HumanModel<ShotgunguyEntity>(0.5f, false), 0.5f);
