...
public class ShotgunguyRender extends MobEntityRenderer<ShotgunguyEntity, DemonModel<ShotgunguyEntity>> {
	...
	public ShotgunguyRender(EntityRenderDispatcher renderManagerIn) {
		super(renderManagerIn, new DemonModel<ShotgunguyEntity>(0.5f, false), 0.5f);
