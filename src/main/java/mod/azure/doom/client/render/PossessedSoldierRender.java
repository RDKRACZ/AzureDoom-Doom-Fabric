...
public class PossessedSoldierRender
		extends MobEntityRenderer<PossessedSoldierEntity, HumanModel<PossessedSoldierEntity>> {
	...
	public PossessedSoldierRender(EntityRenderDispatcher renderManagerIn) {
		super(renderManagerIn, new HumanModel<PossessedSoldierEntity>(0.5f, false), 0.5f);
