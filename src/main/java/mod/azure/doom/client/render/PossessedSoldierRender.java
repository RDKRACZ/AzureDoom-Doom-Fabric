...
public class PossessedSoldierRender
		extends MobEntityRenderer<PossessedSoldierEntity, UnarmedModel<PossessedSoldierEntity>> {
	...
	public PossessedSoldierRender(EntityRenderDispatcher renderManagerIn) {
		super(renderManagerIn, new UnarmedModel<PossessedSoldierEntity>(0.5f, false), 0.5f);
