...
public class Imp2016Render extends MobEntityRenderer<Imp2016Entity, DemonModel<Imp2016Entity>> {
	...
	public Imp2016Render(EntityRenderDispatcher renderManagerIn) {
		super(renderManagerIn, new DemonModel<Imp2016Entity>(0.5f, false), 0.5f);
	}
