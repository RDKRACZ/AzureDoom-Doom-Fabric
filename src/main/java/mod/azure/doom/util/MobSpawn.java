		...
		for (Biome biome : BuiltinRegistries.BIOME) {
			if (biome.getCategory().equals(Biome.Category.NETHER)) {
				addMobSpawnToBiome(biome, SpawnGroup.MONSTER,
						new SpawnSettings.SpawnEntry(ModEntityTypes.IMP, config.imp_spawn_weight, config.imp_min_group,
						...
						new SpawnSettings.SpawnEntry(ModEntityTypes.HELLKNIGHT2016, config.hellknight2016_spawn_weight,
								config.hellknight2016_min_group, config.hellknight2016_max_group),
						new SpawnSettings.SpawnEntry(ModEntityTypes.DREADKNIGHT, config.hellknight2016_spawn_weight,
								config.hellknight2016_min_group, config.hellknight2016_max_group),
						...
						new SpawnSettings.SpawnEntry(ModEntityTypes.CYBERDEMON2016, config.cyberdemon2016_spawn_weight,
						...
						new SpawnSettings.SpawnEntry(ModEntityTypes.SPIDERMASTERMIND2016,
								config.spider_mastermind_spawn_weight, config.spider_mastermind_min_group,
								config.spider_mastermind_max_group),
						new SpawnSettings.SpawnEntry(ModEntityTypes.DOOMHUNTER, config.doomhunter_spawn_weight,
								config.doomhunter_min_group, config.doomhunter_max_group),
						new SpawnSettings.SpawnEntry(ModEntityTypes.PINKY2016, config.pinky_spawn_weight,
								config.pinky_min_group, config.pinky_max_group),
						...
						new SpawnSettings.SpawnEntry(ModEntityTypes.SUMMONER, config.summoner_spawn_weight,
								config.summoner_min_group, config.summoner_max_group),
						new SpawnSettings.SpawnEntry(ModEntityTypes.WHIPLASH, config.whiplash_spawn_weight,
								config.whiplash_min_group, config.whiplash_max_group),
						new SpawnSettings.SpawnEntry(ModEntityTypes.BARON2016, config.baron_spawn_weight,
								config.baron_min_group, config.baron_max_group),
						new SpawnSettings.SpawnEntry(ModEntityTypes.FIREBARON, config.baron_spawn_weight,
								config.baron_min_group, config.baron_max_group),
						new SpawnSettings.SpawnEntry(ModEntityTypes.ARMORBARON, config.armoredbaron_spawn_weight,
								config.armoredbaron_min_group, config.armoredbaron_max_group),
						new SpawnSettings.SpawnEntry(ModEntityTypes.TYRANT, config.tyrant_spawn_weight,
								config.tyrant_min_group, config.tyrant_max_group));
			}
		}
	}
