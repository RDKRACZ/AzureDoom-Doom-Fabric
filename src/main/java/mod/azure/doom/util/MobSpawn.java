...
//						new SpawnSettings.SpawnEntry(ModEntityTypes.BARON2016,
//								config.baron_spawn_weight,
//								config.baron_min_group, config.baron_max_group),
//						new SpawnSettings.SpawnEntry(ModEntityTypes.FIREBARON,
//								config.baron_spawn_weight,
//								config.baron_min_group, config.baron_max_group),
//						new SpawnSettings.SpawnEntry(ModEntityTypes.ARMORBARON,
