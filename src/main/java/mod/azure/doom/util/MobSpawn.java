		...
		for (Biome biome : BuiltinRegistries.BIOME) {
			if (biome.getCategory().equals(Biome.Category.NETHER)) {
				addMobSpawnToBiome(biome, SpawnGroup.MONSTER,
						...
						new SpawnSettings.SpawnEntry(MobEntityRegister.IMP_STONE, config.impstone_spawn_weight,
						...
						new SpawnSettings.SpawnEntry(MobEntityRegister.DREADKNIGHT,
								config.hellknight2016_spawn_weight, config.hellknight2016_min_group,
								config.hellknight2016_max_group),
						...
						new SpawnSettings.SpawnEntry(MobEntityRegister.PROWLER, config.prowler_spawn_weight,
